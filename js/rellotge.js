export function relojAnalogico(divReloj, ampm) {
  function crearReloj(divReloj) {
    ...
    segundos.style.border = '3px solid black';
    ...
    minutos.style.border = '3px solid black';
    ...
    digital.id = 'digital';
    digital.class = 'reloj digital';
    divReloj.appendChild(digital);
    digital.style.position = 'relative';
    digital.style.height = '13%';
    digital.style.top = '2%';
    digital.style.textAlign = 'center';
    digital.style.color = 'black';
    digital.style.fontSize = '100%';
  ...
  function mostrarHora(tiempo) {
    ...
    var hora = document.getElementById('digital');
    if (segundos < 10) {
      segundos = '0' + segundos;
    }
  ...
  function mostrarHoraAMPM(tiempo) {
    var segundos = tiempo.getSeconds();
    var minutos = tiempo.getMinutes();
    var horas = tiempo.getHours();
    var hora = document.getElementById('digital');
    ...
    hora.innerHTML = 'Hora: ' + horas + ' : ' + minutos + ' : ' + segundos + " " + ampm;
  }


  function actualizarRelojAMPM(horaRef, horaActual) {
    mostrarHoraAMPM(horaActual);
  ...
  if (ampm) {
    actualizarRelojAMPM(horaRef, calcularHora())
    ClearAllIntervals();
    setInterval(function () { actualizarRelojAMPM(horaRef, calcularHora()) }, 1);
